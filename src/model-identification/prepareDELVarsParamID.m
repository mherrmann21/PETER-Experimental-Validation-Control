function [c_DEL, y] = prepareDELVarsParamID(IDSystemNLP, simPars, ...
    ...
    stepFun = casadi.Function('FStep', ...
        ...
        [{DEL_res_k_sym}; y_IMU_gyr; y_IMU_acc; {yLt}]);
    ...
    if opts.useFunctionMap
        ...
        y.Lt      = cell(nSteps+1,1);

        for k = 2:nSteps
            % [c_DEL{k}, ...
            %     y.IMUGyr1{k}, y.IMUGyr2{k}, ...
            %     y.IMUAcc1{k}, y.IMUAcc2{k}, ...
            %     y.Lt{k}] = stepFun(q(:,k-1), q(:,k), q(:,k+1), u(:,k), paramVecSym);
            ...
            y.Lt{k} = computeTendonLengthSystemOutput_casadi(MBSys, tendonDef,...
                q_k, g_rel_k);
        end
        ...
        y.Lt      = horzcat(y.Lt{yStepIndices});
    end
end
